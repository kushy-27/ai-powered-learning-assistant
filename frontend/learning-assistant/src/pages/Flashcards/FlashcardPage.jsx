...
const FlashcardPage = () => {
    ...
    const fetchFlashcards = async () => {
        setLoading(true);
        try {
            const response = await flashcardService.getAllFlashcardForDocument( documentId );
        ...
        <div>
            <div className="mb-4">
                <Link
                    ...
                    className="inline-flex items-center gap-2 text-sm text-neutral-600 hover:text-neutral-500 transition-colors"
                >
                    <ArrowLeft size={16} />
                    Back to Document
                </Link>
