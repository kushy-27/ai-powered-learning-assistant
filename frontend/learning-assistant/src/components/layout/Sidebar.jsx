...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
        ...
        <aside
          className={`fixed md:static top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-lg border-r border-slate-200/60 z-50 md:z-auto flex flex-col transition-transform duration-300 ease-in-out
